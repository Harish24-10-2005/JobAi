...
class Console:
    ...
    def success(self, message: str):
        ...
        print(self._colorize(f"  {self.SYMBOL_SUCCESS} {message}", Colors.BRIGHT_GREEN))
    
    def error(self, message: str):
        """Print an error message."""
        print(self._colorize(f"  {self.SYMBOL_ERROR} {message}", Colors.BRIGHT_RED))
    
    def warning(self, message: str):
        """Print a warning message."""
        print(self._colorize(f"  {self.SYMBOL_WARNING} {message}", Colors.BRIGHT_YELLOW))
    
    def info(self, message: str):
        """Print an info message."""
        print(self._colorize(f"  {self.SYMBOL_INFO} {message}", Colors.BRIGHT_BLUE))
    
    def step(self, number: int, total: int, message: str):
        """Print a step indicator."""
        progress = f"[{number}/{total}]"
        print(self._colorize(f"  {progress} ", Colors.BRIGHT_MAGENTA) + 
